...
def print_report(
    ...
    for label, key, unit in metrics:
        ...
        delta = round(candidate_value - baseline_value, 1)
        ...
        print(
            f"  {label:<25} {baseline_value:>9}{unit} "
            f"{candidate_value:>9}{unit} "
            f"{sign}{delta:>8}{unit}{flag}"
        )
    ...
    if "BLOCK" in decisions:
        ...
        final_decision = "WARNING \u2013 review before merging"
    else:
        final_decision = "PASSED \u2013 safe to merge"
...
def main() -> None:
    ...
    parser.add_argument(
        "--ci-mode",
        action="store_true",
        help="Suppress per-case output for CI logs",
    )
